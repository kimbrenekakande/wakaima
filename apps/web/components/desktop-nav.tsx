			...
			<NavigationMenuList>
				<NavigationMenuItem>
					...
					<NavigationMenuContent className="p-1 pr-1.5">
						<div className="rounded-md grid w-lg grid-cols-2 gap-2 border bg-card p-2 shadow">
				...
				<NavigationMenuItem>
					...
					<NavigationMenuContent className="p-1 pr-1.5 pb-1.5">
						<div className="grid w-lg grid-cols-2 gap-2">
							<div className="rounded-md space-y-2 border bg-card p-2 shadow">
				...
				<NavigationMenuLink className="px-4" href="/#pricing">
					Pricing
				</NavigationMenuLink>
			</NavigationMenuList>
		</NavigationMenu>
